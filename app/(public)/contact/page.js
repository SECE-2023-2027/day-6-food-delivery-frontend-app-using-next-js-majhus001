        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">123 Food Street, Foodville, FK 12345</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">info@foodexpress.com</p>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="bg-gray-100 hover:bg-orange-100 p-3 rounded-full transition-colors">
